...
public class CommentDAO {
    ...
    private final String GET_COUNT_COMMENTS = "select count(*) from comments where users_username = ?";
    ...
    public int getCountCommentsByUser (String user){return this.jdbcTemplate.queryForObject(GET_COUNT_COMMENTS,Integer.class,user);}
